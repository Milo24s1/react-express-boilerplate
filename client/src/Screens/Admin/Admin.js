...
class Admin extends Component {
    ...
    componentDidMount() {
        ...
        if (this.props.location.state && (this.props.location.state.reset || this.props.location.state.askReset)) {
    ...
    Signup = (e) => {
        ...
        if (isEmail && this.state.inputs.email && this.state.inputs.password && this.state.inputs.password.length >= 6) {
            ...
            .then((res) => {
                ...
                if (res.data.name == 'UserExistsError') { // check if email exist from Passport 
                ...
                <div className='admin-signup-section container-signup container'>
                {
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div>
                                <Input error={this.state.errors.email ||this.state.errors.isEmailErr == true ? true : false}  className='admin-form' onChange={e => this.handleInput(e)} value={this.state.inputs.email} name="email"  type="text" placeholder="email"/>
